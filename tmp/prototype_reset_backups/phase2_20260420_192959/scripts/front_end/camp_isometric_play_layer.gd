...
func _build_default_camp() -> void:
	_world_objects = [
		...
		CampWorldObjectScript.new({"id": &"lean_to_w", "position": CAMP_CENTER + Vector2i(-6, -2), "type": &"tarp_shelter", "interaction_type": &"", "display_name": "Lean-to", "size_tiles": Vector2i(3, 2), "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"lean_to_e", "position": CAMP_CENTER + Vector2i(4, -5), "type": &"tarp_shelter", "interaction_type": &"", "display_name": "Lean-to", "size_tiles": Vector2i(3, 2), "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"log_sw", "position": CAMP_CENTER + Vector2i(-5, 5), "type": &"log", "interaction_type": &"", "display_name": "Log Seat", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"log_s", "position": CAMP_CENTER + Vector2i(1, 6), "type": &"log", "interaction_type": &"", "display_name": "Log Seat", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"stump_s", "position": CAMP_CENTER + Vector2i(-1, 5), "type": &"stump", "interaction_type": &"", "display_name": "Stump", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"crate_e", "position": CAMP_CENTER + Vector2i(5, 2), "type": &"crate", "interaction_type": &"", "display_name": "Crate", "is_interactable": false}),
		CampWorldObjectScript.new({
			"id": &"wash_line",
			"position": CAMP_CENTER + Vector2i(6, -3),
			"type": &"wash_line",
			"interaction_type": &"page",
			"route_id": &"ready",
		...
		CampWorldObjectScript.new({"id": &"coffee_setup", "position": CAMP_CENTER + Vector2i(1, 1), "type": &"coffee_setup", "interaction_type": &"", "display_name": "Coffee Tin", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"camp_sack", "position": CAMP_CENTER + Vector2i(2, 4), "type": &"stash", "interaction_type": &"", "display_name": "Supply Sack", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"camp_rocks", "position": CAMP_CENTER + Vector2i(-4, -1), "type": &"stump", "interaction_type": &"", "display_name": "Stump", "is_interactable": false})
	]
...
func _build_default_town() -> void:
	_world_objects = [
		...
		CampWorldObjectScript.new({
			"id": &"town_foreman_office",
			"position": TOWN_CENTER + Vector2i(-1, -2),
			"type": &"town_foreman",
			"interaction_type": &"page",
			"route_id": &"town_foreman",
			"display_name": "Foreman's Office",
			"prompt_action": "Ask After Work",
			"page_id": &"jobs_board",
			"size_tiles": Vector2i(3, 3),
			"detail_text": "A place to ask about day labor, crews, and who is hiring before dark."
		}),
		CampWorldObjectScript.new({
			"id": &"town_church",
			"position": TOWN_CENTER + Vector2i(-18, -4),
			"type": &"town_church",
			"interaction_type": &"page",
		...
		CampWorldObjectScript.new({
			"id": &"town_grocery",
			"position": TOWN_CENTER + Vector2i(9, -2),
			"type": &"town_grocery",
			"interaction_type": &"page",
		...
		CampWorldObjectScript.new({
			"id": &"town_hardware",
			"position": TOWN_CENTER + Vector2i(18, -1),
			"type": &"town_hardware",
			"interaction_type": &"page",
		...
		CampWorldObjectScript.new({
			"id": &"town_camp_road",
			"position": TOWN_CENTER + Vector2i(22, 8),
			"type": &"town_road_exit",
			"interaction_type": &"action",
			"route_id": &"town_exit",
		...
		CampWorldObjectScript.new({"id": &"town_lamp_w", "position": TOWN_CENTER + Vector2i(-7, 4), "type": &"town_prop_light", "display_name": "Street Lamp", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_lamp_e", "position": TOWN_CENTER + Vector2i(12, 4), "type": &"town_prop_light", "display_name": "Street Lamp", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_trash_grocery", "position": TOWN_CENTER + Vector2i(13, 1), "type": &"town_prop_trash", "display_name": "Trash Bin", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_crate_hardware", "position": TOWN_CENTER + Vector2i(21, 1), "type": &"town_prop_crate_stack", "display_name": "Delivery Crate", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_board_stack_depot", "position": TOWN_CENTER + Vector2i(-3, 1), "type": &"town_prop_board_stack", "display_name": "Board Stack", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_wheelbarrow_depot", "position": TOWN_CENTER + Vector2i(1, 2), "type": &"town_prop_wheelbarrow", "display_name": "Wheelbarrow", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_handcart_shop", "position": TOWN_CENTER + Vector2i(15, 2), "type": &"town_prop_handcart", "display_name": "Handcart", "is_interactable": false}),
		CampWorldObjectScript.new({"id": &"town_lanterns_board", "position": TOWN_CENTER + Vector2i(-9, 4), "type": &"town_prop_lanterns", "display_name": "Lanterns", "is_interactable": false})
	]
	_add_town_tree_edges()
	_rebuild_world_object_cache()
	_apply_interaction_overrides()
